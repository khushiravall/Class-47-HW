class Game{
  ...
  showRank() {
    ...
    showLife(){
      push()
      image(lifeImage, width /2 - 300, height - playerObject.positionY - 745, 20, 20);
      fill("white");
      rect(width / 2 - 265, height - playerObject.positionY - 745, 185, 20);
      fill("#f50057");
      rect(width / 2 - 265, height - playerObject.positionY - 745, playerObject.life, 20);
      noStroke();
      pop()
    }
